...
public class FilmeDAO {
	...
	public FilmeDAO() {
		...
		//Implementando a lista com a estrutura de um ArrayList
		if(listaFilme == null) {
			...
			fb.setDuracao(360);
			fb.setGenero("acao");
			//Adicionando o primeiro filme na lista
			listaFilme.add(fb);
			...
			//Adicionando o segundo filme na lista
			listaFilme.add(fb);
			...
			fb.setDuracao(370);
			fb.setGenero("drama");
			//Adicionando o terceiro filme na lista
			listaFilme.add(fb);
